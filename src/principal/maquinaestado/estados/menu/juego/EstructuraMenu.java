...
public class EstructuraMenu {
	...
	public void dibujar(final Graphics g) {
		DibujoDebug.dibujarRectangulosRelleno(g, BANNER_SUPERIOR, COLOR_BANNER_SUPERIOR);
		DibujoDebug.dibujarRectangulosRelleno(g, BANNER_LATERAL, COLOR_BANNER_LATERAL);
		DibujoDebug.dibujarRectangulosRelleno(g, FONDO, COLOR_FONDO);
	}
